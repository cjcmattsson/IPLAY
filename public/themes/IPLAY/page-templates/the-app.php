    ...
    <div class="col">
        ...
        <h1 class="section-header-text the-app-header"><?php echo $fields['hero_text'] ?></h1>
            <div class="phones">
                ...
                <img class="iphone-left-back" src="themes/IPLAY/assets/images/iphone-kevin.png" alt="">
                <img class="iphone-middle-front" src="themes/IPLAY/assets/images/iphone-kevin.png" alt="">
                <img class="iphone-right-back" src="themes/IPLAY/assets/images/iphone-kevin.png" alt="">
            </div>
            ...
            <div class="about-iplay"><?php echo $fields['about_iplay'] ?></div>
